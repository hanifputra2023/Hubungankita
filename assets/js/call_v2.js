        ...
        if (isApk) {
            if (window.Capacitor && window.Capacitor.Plugins && window.Capacitor.Plugins.ScreenShare) {
                try {
                    ...
                    const captureOpts = useGamingMode ? { scale: 0.60, fps: 30, quality: 70 } : { scale: 0.40, fps: 15, quality: 55 };
                                                    ...
                                                    .then(() => {
                                                        ...
                                                        try {
                                                            ...
                                                            if (parameters.encodings.length > 0) {
                                                                parameters.encodings[0].maxBitrate = useGamingMode ? 2000000 : 600000;
